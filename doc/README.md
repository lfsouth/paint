...
1. Module Makefile, e.g. [mod1/Makefile](https://github.com/lfsouth/paint/blob/master/src/mod1/Makefile), [mod2/Makefile](https://github.com/lfsouth/paint/blob/master/src/mod2/Makefile), [mod11/Makefile](https://github.com/lfsouth/paint/blob/master/src/mod1/mod11/Makefile); they are all complete same.
2. Tool Makefile, e.g. [tool1/Makefile](https://github.com/lfsouth/paint/blob/master/src/tool1/Makefile) and [tool2/Makefile](https://github.com/lfsouth/paint/blob/master/src/tool2/Makefile); they are almost same.
3. [prod/makefiles/module.mk](https://github.com/lfsouth/paint/blob/master/prod/makefiles/module.mk), included by Module Makefile.
4. [prod/makefiles/tool.mk](https://github.com/lfsouth/paint/blob/master/prod/makefiles/tool.mk), included by Tool Makefile.
5. [prod/makefiles/base.mk](https://github.com/lfsouth/paint/blob/master/prod/makefiles/base.mk), included by module.mk and tool.mk.
